...
(function () {
  ...
  var LOG = [
    {
      v: '', d: '2026-09-16', kind: '数据',
      title: '日历扩充：职业证书与校方赛事',
      body: [
        '新增职业证书类提醒：计算机软考（上/下半年）、初级会计、全国大学生英语竞赛（NECCS）、翻译专业资格（CATTI）、普通话水平测试（湖北）——年度规律明确的标「参考推算」。',
        '新增校方已发布赛事：全国大学生数学竞赛（湖北赛区）报名截止 10/10（已核实创新创业学院通知）、初赛约11月初。',
        '此前已加：2027 考研后续节点、上半年教资、2027年3月 NCRE、华为ICT 报名截止（实践赛/挑战赛 10/31，已核实）。'
      ]
    },
    {
